...
import iotfrisbee.domain.{HardwareId, SoftwareId, HardwareControlMessage => Control}
...
import iotfrisbee.web.actors.HardwareControlActor.hardwareSerialMonitorTopic
...
import iotfrisbee.domain.HardwareSerialMonitorMessage.BaudrateChanged
import iotfrisbee.web.actors.HardwareControlState.{ConfiguringMonitor, Initial, Uploading}
