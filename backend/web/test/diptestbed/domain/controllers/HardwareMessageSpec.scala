...
import diptestbed.domain.controllers.HardwareMessageSpec._
import diptestbed.domain.controllers.UserControllerSpec._
import diptestbed.domain.controllers.HardwareSpec._
import diptestbed.domain.{Hardware, HardwareId, HardwareMessage, HardwareMessageId}
...
import diptestbed.web.controllers.{HardwareController, HardwareMessageController, UserController}

class HardwareMessageSpec extends DIPTestbedSpec with GivenWhenThen {
