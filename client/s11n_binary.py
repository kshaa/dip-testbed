...
def serial_monitor_message_to_agent_encode_json(value: protocol.SerialMonitorMessageToAgent) -> BINARY:
...
SERIAL_MONITOR_MESSAGE_TO_AGENT_ENCODER_BINARY: EncoderBinary[protocol.SerialMonitorMessageToAgent] = \
    EncoderBinary(serial_monitor_message_to_agent_encode_json)
SERIAL_MONITOR_MESSAGE_TO_AGENT_DECODER_BINARY: DecoderBinary[protocol.SerialMonitorMessageToAgent] = \
    DecoderBinary(serial_monitor_message_to_agent_decode_json)
...
def serial_monitor_message_to_client_encode_json(value: protocol.SerialMonitorMessageToClient) -> BINARY:
...
SERIAL_MONITOR_MESSAGE_TO_CLIENT_ENCODER_BINARY: EncoderBinary[protocol.SerialMonitorMessageToClient] = \
    EncoderBinary(serial_monitor_message_to_client_encode_json)
SERIAL_MONITOR_MESSAGE_TO_CLIENT_DECODER_BINARY: DecoderBinary[protocol.SerialMonitorMessageToClient] = \
    DecoderBinary(serial_monitor_message_to_client_decode_json)
